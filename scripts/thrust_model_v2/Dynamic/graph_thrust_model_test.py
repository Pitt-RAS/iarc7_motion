...
class RampResponse(object):
    ...
    def find_time_offset(self):
        ...
        interpolated_expected_thrusts = self.expected_thrust_interp(
            interp_times)
        ...
        total_correlations = len(
            interpolated_thrusts) + max_forward_correlation_time
...
def plot_all_responses(
    ...
    for i in range(0, len(ramps)):
        ...
        (predicted_thrust_error_times,
         predicted_thrust_error) = predicted_thrust_error_getter(ramps[i])
...
if __name__ == "__main__":
    ...
    for ramp_responses in ramp_groups:
        ...
        # plot_groups(ramp_responses,
        # group_plotter=plot_all_responses_interpolated)
